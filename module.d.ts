...
import { Config, DeepLinkConfig } from 'ionic-angular';
 ...
 * @hidden
 */
export declare function provideLocationStrategy(platformLocationStrategy: PlatformLocation,
                                                baseHref: string, config: Config): HashLocationStrategy | PathLocationStrategy;
